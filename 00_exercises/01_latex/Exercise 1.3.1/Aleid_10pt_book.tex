\documentclass[10pt, A4, titlepage]{Book}
...
\usepackage[]{hyperref}
\hypersetup{
    pdftitle={Book Virgil's Aeneid},
    pdfauthor={Mano van Holten},
    pdfsubject={Exercise 1.3.1 Latex},
...
\title{BkI:1-11 Invocation to the Muse\\ \small A translation of Virgil's Aeneid}
...
% to compile:
% cd "C:\Users\Admin\Desktop\UU\Mlarpis\Mlarpis_git\markup_deliverables\00_exercises\01_latex\Exercise 1.3.1"
% pdflatex Aleid_10pt_book.tex
